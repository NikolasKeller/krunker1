...
const visibleFields = ['id', 'name', 'classId', 'team', 'bot', 'ready', 'x', 'y', 'z', 'vx', 'vy', 'vz', 'yaw', 'pitch', 'slide', 'grounded', 'alive', 'hp', 'maxHp', 'kills', 'deaths', 'score', 'weapon', 'aiming', 'life', 'protectionEnd', 'abilityUntil'] as const;
